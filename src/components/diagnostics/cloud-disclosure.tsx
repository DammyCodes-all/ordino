  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4 backdrop-blur-sm">
      <div
        ...
        className="w-full max-w-md rounded-2xl border border-border bg-surface-raised p-6 shadow-2xl animate-fade-up"
      >
        <p className="text-[11px] uppercase tracking-[0.2em] text-muted-dim">
          Before you generate
        </p>
        <h2
        ...
        <div className="mt-6 flex gap-2">
          {cloudDisclosureAccepted ? (
            <button
              ...
              className="flex-1 rounded-xl border border-border px-4 py-2.5 text-sm text-muted hover:text-foreground"
            >
              Close
            </button>
          ) : (
          ...
          <button
            ...
            className="flex-1 rounded-xl bg-foreground px-4 py-2.5 text-sm font-medium text-background"
          >
