...
export function PreviewSidebar() {
  ...
  return (
    <>
      ...
      />
      <aside className="fixed inset-y-0 right-0 z-40 flex h-full w-[min(100%,28rem)] flex-col border-l border-border-subtle bg-surface shadow-2xl animate-fade-up md:static md:z-auto md:w-[58%] md:min-w-[22rem] md:max-w-[46rem] md:shadow-none">
